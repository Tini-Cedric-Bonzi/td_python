...
# nous allons tout d'abord definir une fonction qui permettra à l'utilsateur d'entrer une note y compris des notes decimale #
def mention_note():
    note = float(input("Entrez une note: "))
# nous allons à présent demander à notre programme d'afficher les mentions en fonction des notes entrer #
    if note >= 18:
        print("Excellent")
    elif note >= 16:
        print("Très bien")
